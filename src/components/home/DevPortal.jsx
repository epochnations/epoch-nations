...
const API_METHODS = [
  { method: "api.registerBuilding(config)",    returns: "boolean", desc: "Register a new building type" },
  { method: "api.registerResource(config)",    returns: "boolean", desc: "Register a new resource/commodity" },
  { method: "api.registerLanguage(config)",    returns: "boolean", desc: "Register a translation pack" },
  { method: "api.registerEconomyRule(config)", returns: "boolean", desc: "Register a per-tick economy hook" },
  { method: "api.registerResearchTree(config)",returns: "boolean", desc: "Register a custom tech branch" },
  { method: "api.registerEvent(config)",       returns: "boolean", desc: "Register a world event" },
  { method: "api.registerUIComponent(config)", returns: "boolean", desc: "Inject a React component into a UI slot" },
  { method: "api.getNationData()",             returns: "Object (frozen)", desc: "Read-only snapshot of current player's nation" },
  { method: "api.getRegisteredBuildings()",    returns: "Array",   desc: "List all registered buildings (core + plugin)" },
  { method: "api.getRegisteredResources()",    returns: "Array",   desc: "List all registered resources" },
  { method: "api.translate(key, locale)",      returns: "string",  desc: "Translate a string key using registered language packs" },
  { method: "api.on(event, fn)",               returns: "void",    desc: "Subscribe to game engine events" },
  { method: "api.off(event, fn)",              returns: "void",    desc: "Unsubscribe from events" },
];
