...
const SECTIONS_INLINE = [
  ...
  { id: "world-map", icon: "🗺️", color: "#06b6d4", title: "World Map & Navigation", summary: "Explore the ocean, claim islands, and interact with the living world.", steps: [
    ...
    { title: "Zooming In & Out", body: "Use the +/− buttons in the bottom-right corner of the map to zoom in and out. Scroll wheel zoom is disabled to prevent accidental zooming while browsing. Double-click anywhere to zoom into a specific area.", tip: "Zoom in close to an island to see buildings, flags, development level indicators, and resource markers.", deepDive: "#map" },
