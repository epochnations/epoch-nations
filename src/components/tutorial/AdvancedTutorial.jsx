...
const SECTIONS_INLINE = [
  ...
  { id: "crafting", icon: "🔨", color: "#f97316", title: "Island Crafting System", summary: "Transform raw resources into refined materials and bonuses.", steps: [
    { title: "Crafting Basics", body: "Each island you own has a Crafting tab in the Island Panel. Open an island, click the 🔨 Craft tab, and you'll see all available recipes. Crafting converts raw resources into credits, military power, GDP, or stability bonuses.", tip: "Crafting is one of the fastest ways to convert excess resources into credits. Run it constantly on your richest islands.", deepDive: null },
    { title: "Craft Chains", body: "Resources follow a progression: Wood → Planks → Tools. Stone → Bricks → Buildings. Iron → Iron Bars → Weapons. Each step up the chain produces more value. Craft your way up whenever resources allow.", tip: "Don't just sit on raw resources. Crafting Wooden Planks gives +80 credits per 10 wood — far better than stockpiling.", deepDive: null },
    { title: "Crafting Progress Bar", body: "When you start crafting, a glowing animated progress bar appears with sparkling particles. The recipe completes automatically — you don't need to click anything. Rewards are applied instantly to your nation stats.", tip: "You can only run one craft at a time per island. Queue up your most valuable recipe first.", deepDive: null },
    { title: "Resource Requirements", body: "Each recipe shows required resources with color indicators: green = you have enough, red = you need more. The Inventory tab shows your current stockpile at a glance.", tip: "Run Farmers and Lumberjacks first to build up stockpiles, then switch to heavy crafting during peak resource production.", deepDive: null },
  ]},
