...
const SECTIONS_INLINE = [
  { id: "dashboard", icon: "🏛️", color: "#22d3ee", title: "Dashboard Overview", summary: "Your command center — everything starts here.", steps: [
    ...
    { title: "Dashboard Layout", body: "The dashboard uses a 3-column bento layout on desktop. Left: Nation Stats. Center: World Map + Chat. Right: Metrics + Stock Ticker. On mobile it stacks vertically with a scrollable bottom action bar.", tip: "Spend a few minutes just exploring each panel before diving into game actions. Everything is visible at a glance.", deepDive: "#dashboard-layout" },
    { title: "Tutorial & Help Button", body: "The '📖 Tutorial' button in the top bar opens this guide at any time. You can jump between sections and re-read any topic whenever you need a refresher.", tip: "There's a lot to learn — you don't need to memorize it all at once. Come back whenever you need a refresher.", deepDive: "#tutorial-button" },
  ]},
  { id: "nation-stats", icon: "📊", color: "#4ade80", title: "Nation Stats Panel", summary: "Your nation's vital signs — GDP, stability, resources & more.", steps: [
    ...
    { title: "Stability & Public Trust", body: "Stability (0–100) governs your nation's political health. Public Trust (0.1–2.0) multiplies tax effectiveness. Both are shown in the Nation Stats panel with trend arrows. Low stability triggers crises; low trust triggers protests.", tip: "Keep stability above 50 at all times. Below 40 and your GDP starts to drag noticeably.", deepDive: "#stability-deep" },
    { title: "Notifications", body: "The notification bell in the header bar shows unread alerts for wars, stock crashes, ally attacks, trade proposals, and more. Red notifications are urgent. Green are positive milestones.", tip: "Check notifications at session start. Offline events can dramatically change your strategic situation.", deepDive: "#notifications" },
  ]},
  ...
  { id: "world-map", icon: "🗺️", color: "#06b6d4", title: "World Map & Navigation", summary: "Explore the ocean, claim islands, and interact with the living world.", steps: [
    { title: "Map Navigation — Hold to Move", body: "To move the world map, HOLD DOWN your left mouse button and drag. Simply moving your mouse without clicking does NOT move the map — this is intentional so you can hover over islands without accidentally panning.", tip: "On touch screens, press and hold then drag with one finger. Two-finger pinch to zoom in/out.", deepDive: "#map" },
    { title: "Zooming In & Out", body: "Use your scroll wheel to zoom. Scroll up = zoom in, scroll down = zoom out. You can also use the +/− buttons in the bottom-right corner of the map. Double-click to zoom to a specific location.", tip: "Zoom in close to an island to see buildings, flags, development level indicators, and resource markers.", deepDive: "#map" },
    { title: "Hex Island Tiles", body: "The world is made up of hexagonal island tiles scattered across an infinite ocean. Each tile has a terrain type (tropical, forest, mountains, desert, tundra, coastal, volcanic, plains, rocky) that determines its resources.", tip: "Your owned islands pulse with a cyan glow. Enemy islands flash red. Hover over any island to see a tooltip with owner and terrain.", deepDive: "#terrain" },
    { title: "Claiming Islands", body: "Click any unclaimed island hex to open the Island Panel and purchase it. Owned enemy islands can be attacked via the 'Launch Naval Assault' button — this triggers a full battle animation.", tip: "Unclaimed islands near the center are cheaper. Islands far from your territory cost exponentially more.", deepDive: "#expansion" },
    { title: "Island Panel", body: "Clicking any island opens the Island Command Center panel on the right side. It has 6 tabs: Overview, Resources, Build, Military, Craft, and Inventory. Everything about the island is managed here — no scrolling needed.", tip: "The panel dims the map behind it. Click the dark overlay or the X button to close.", deepDive: "#cities" },
    { title: "My Islands List", body: "Click the islands count button (your flag emoji + number) in the map top bar to open your islands navigation list. Click any island in the list to instantly fly the camera to it.", tip: "Use this to quickly check on all your territories without manually searching the map.", deepDive: "#map" },
  ]},
  { id: "island-mgmt", icon: "🏝️", color: "#22d3ee", title: "Island Management", summary: "Full SimCity-style island hubs — power, water, production, workers & defense.", steps: [
    { title: "Island Management Page", body: "Clicking any island on the world map opens the Island Management Page — a full-screen hub with 8 tabs: Overview, Production, Utilities, Storage, Buildings, Crafting, Workers, and Defense. This is where all island operations happen.", tip: "The header always shows live Power ⚡ and Water 💧 status badges so you can spot shortages at a glance.", deepDive: null },
    { title: "Power System", body: "Every production building consumes power. Build Wind Turbines (+25W), Solar Arrays (+40W), or Coal Power Plants (+100W) in the Utilities tab to generate electricity. If power generation < consumption, machines slow down.", tip: "Start with a Wind Turbine on every island that has more than 3 production buildings.", deepDive: null },
    { title: "Water System", body: "Farms, hospitals, refineries, and other buildings require water. Build Freshwater Wells (+20), Water Pump Stations (+50), or Reservoirs (+100) in the Utilities tab. Water shortages cut production efficiency.", tip: "Coastal and plains islands are best for agriculture — always pair farms with a Water Pump.", deepDive: null },
    { title: "Production Tab", body: "The Production tab lists all production buildings with their status. Green ✓ Active = fully powered and watered. Red ⚠ Offline = missing power or water. Each machine shows its exact power and water consumption.", tip: "Fix offline machines immediately — they produce nothing while idle, wasting potential resources.", deepDive: null },
    { title: "Workers Tab", body: "Assign your national workforce across 12 worker types directly from the island page. Changes apply to all islands — your workers form a national pool. Hit 'Apply' to save reassignments.", tip: "Balance Farmers (food), Lumberjacks (wood), and Researchers (tech points) before assigning anyone to soldiers.", deepDive: null },
    { title: "Storage Tab", body: "The Storage tab shows your national stockpile with visual progress bars for all 6 resources. It also shows this island's specific production contribution per tick, so you can see which islands are your best producers.", tip: "If a storage bar hits 95%, production stops for that resource. Build a Warehouse (Buildings → Economic) to increase capacity.", deepDive: null },
  ]},
  { id: "island-battle", icon: "⚔️", color: "#f87171", title: "Island Combat & Claiming", summary: "Launch naval assaults, watch battles, and capture enemy territory.", steps: [
    { title: "Naval Assault System", body: "When you click an island owned by another nation, you'll see a Combat Preview in the Island Panel showing your Fleet Power vs their Island Defense rating. Click 'Launch Naval Assault' to trigger the full battle animation.", tip: "Build Barracks (+15 attack) and Forts (+20 defense) on your islands before engaging in combat.", deepDive: "#war" },
    { title: "Battle Animation", body: "The battle animation shows your fleet approaching, cannon fire exchanged, explosions, smoke, damage numbers, and a dramatic resolution sequence. Click 'Claim Victory' or 'Repelled' when prompted to apply the result.", tip: "Win probability is shown before you attack. Above 70%? Go for it. Below 40%? Reinforce first.", deepDive: "#war" },
    { title: "Win Conditions", body: "Win probability = Your Power / (Your Power + Island Defense). Island Defense grows with military buildings (Fort, Barracks, Naval Base, Radar). Each adds +10 to defense score.", tip: "Scout enemy islands first. An island with a Fort + Naval Base has 30+ defense — you need at least 60 total power to reliably win.", deepDive: "#war" },
    { title: "After Battle", body: "Victory: Island ownership transfers to you, the prior owner is added to your at_war_with list, and a 200 credit cost is deducted. Defeat: A system message is broadcast and defenses hold.", tip: "After capturing an island, immediately build a Fort to defend against counter-attacks.", deepDive: "#war" },
  ]},
  { id: "diplomacy-peace", icon: "🤝", color: "#4ade80", title: "Diplomacy & War", summary: "Form alliances, trade, negotiate — or conquer.", steps: [
    { title: "Nation Interaction", body: "All nation diplomacy happens through the Global Chat, Diplomacy Panel, or the island panels. Use /ally @Nation, /trade @Nation, /war @Nation, /aid @Nation commands in chat.", tip: "Check a nation's military power before declaring war. Attacking a stronger nation is usually a catastrophic mistake.", deepDive: "#diplomacy" },
    ...
    { title: "Lend-Lease & Foreign Aid", body: "You can send Credits, Resources, or Tech Points to any nation at any time via their profile. Aid builds diplomatic goodwill and is logged publicly in the Activity Ledger.", tip: "Small repeated aid packages build trust faster than a single large transfer. Invest in relationships before you need them.", deepDive: "#lend-lease" },
    { title: "Peace Negotiations", body: "Either party in a war can propose peace at any time via the Diplomacy Panel or World Chat commands. Peace terms can include resource or credit transfers. Wars also auto-expire after ~3.5 hours.", tip: "The ideal time to offer peace is after landing your strongest attacks — lock in your advantage before momentum shifts.", deepDive: "#peace-deals" },
  ...
  { id: "city-management", icon: "🏙️", color: "#f59e0b", title: "City Management", summary: "Zone districts, manage happiness, build services — grow your cities.", steps: [
    ...
    { title: "City Budget & Finance", body: "Each city runs its own budget. City surplus adds to your national treasury each tick; a deficit drains it. Set the city tax rate via the Budget panel. Higher taxes generate more income but lower city happiness.", tip: "Don't over-tax new cities — population growth in early stages generates far more long-term revenue.", deepDive: "#city-budget" },
    { title: "City Population Growth", body: "City population grows when happiness is high, crime is low, health is good, and housing capacity has room. Population determines your tax base and commercial revenue. Trigger immigration waves by keeping all city stats healthy.", tip: "Happiness is the master lever for city growth — prioritize it over all other city stats.", deepDive: "#city-growth" },
  ...
  { id: "crafting", icon: "🔨", color: "#f97316", title: "Machine-Based Crafting", summary: "Use machines to transform raw resources into refined goods, weapons, fuel, and more.", steps: [
    { title: "The Crafting Tab", body: "Each island you own has a Crafting tab (🔨) in the Island Panel. Inside, you'll see 6 machines: Forge, Sawmill, Kiln, Kitchen, Workshop, and Refinery. Each machine specializes in specific crafting chains.", tip: "The Forge is your most important early machine — it smelts iron and forges weapons directly boosting your military power.", deepDive: null },
    { title: "Machine Layout — Input → Machine → Output", body: "Every machine has an INPUT SLOTS section on the left showing required resources (green = enough, red = need more), the MACHINE in the center that animates while crafting, and an OUTPUT SLOT on the right showing what you'll receive.", tip: "The animated machine glow, sparks, and smoke effects tell you it's actively crafting. Watch for the progress bar filling up below the machine.", deepDive: null },
    { title: "Selecting and Starting a Recipe", body: "Click any recipe card in the list below the machine view to select it. Input slots update to show what's required. When all inputs are green, the Craft button activates. Click it to begin — the machine comes to life!", tip: "Each machine auto-selects the first craftable recipe when you open it. If nothing is selected, you're short on at least one resource.", deepDive: null },
    { title: "Machine Types & Specializations", body: "🔥 Forge — Iron bars, weapons, gold coins, steel alloys. 🪚 Sawmill — Planks, luxury lumber, timber frames. 🧱 Kiln — Bricks, glass panes, ceramics. 🍳 Kitchen — Rations, grand feasts, medicinal brews. 🔨 Workshop — Tool sets, trade goods, defensive gear. ⛽ Refinery — Fuel, chemical reagents, polymers.", tip: "The Refinery requires Oil but produces the highest credit rewards and GDP bonuses of any machine.", deepDive: null },
    { title: "Production Chains", body: "Resources flow through machines in chains: Iron Ore → Forge → Iron Bars → Workshop → Tool Sets. Stone → Kiln → Bricks → (build Housing). Oil → Refinery → Fuel → (military & GDP). Each step increases value.", tip: "The Item Encyclopedia (accessible from the Dashboard) shows full visual production chain diagrams for every item in the game — over 1,400 items total.", deepDive: null },
    { title: "Resource Indicators & Inventory", body: "Each input slot shows: the resource emoji, required amount, and your current stockpile below in green (enough) or red (need more). The Inventory tab in the same island panel shows your full national stockpile at a glance.", tip: "Farm and produce resources first, then run crafting sessions. A single Refinery run on 20 oil gives +280 credits and +8 manufacturing.", deepDive: null },
  ]},
  { id: "marketplace", icon: "🏪", color: "#34d399", title: "Marketplace & Trade", summary: "Buy resources, set up trade routes, and access global commodity markets.", steps: [
    ...
    { title: "How Market Prices Work", body: "Commodity prices update every tick based on global supply and demand. Shortages spike prices dramatically. Surpluses crash them. Watch the sparkline trend and supply/demand ratio, not just the current price.", tip: "Buy resources when supply exceeds demand. Sell when demand exceeds supply. The sparkline tells the story.", deepDive: "#market-prices" },
  ...
  { id: "news-government", icon: "🏛️", color: "#c084fc", title: "Government & News", summary: "Policy, propaganda, dilemmas, and the press — govern your nation.", steps: [
    ...
    { title: "Influence Points", body: "Influence Points (IP) are your diplomatic currency spent on chat commands like /spy, /ally, /sanction, and propaganda publishing. They regenerate passively each tick. Build a National Library or Palace to increase your regen rate.", tip: "Keep at least 20 IP in reserve at all times — spy reports before any military action are non-negotiable.", deepDive: "#influence-points" },
